<?php
    ...
    $no_agenda_keluar = htmlentities($_GET['no_agenda_keluar']);
    $sql = "SELECT * FROM tbl_surat_keluar WHERE no_agenda_keluar = '$no_agenda_keluar'";
  ...
  <div class="container">
    <div class="row">
      ...
      <legend>Ubah Data Surat keluar</legend>
        <form method="POST" action="perbarui-data-surat-keluar.php">
          <div class="form-group">
            <div class="input-group col-md-4">
            <label>No Agenda</label>
            <input type="text" name="no_agenda_keluar" value="<?php echo $data2['no_agenda_keluar']; ?>" class="form-control" id="no_agenda_keluar"></input>
            </div>
          </div>
          <div class="form-group">
            <div class="input-group col-md-4">
