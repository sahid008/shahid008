...
<html lang="en">
  ...
  <p><a href="tambah-data-surat-masuk.php"><button type="button" class="btn btn-primary">Tambah Data</button></a></p>
  ...
  <table class="table table-responsive table-bordered container well">
      ...
      <tr class="warning">
        ...
        <td width="10%"><label>Tanggal Terima</label></td>
    ...
    ?>
        ...
        <td align="center">
        <a href="ubah-data-surat-masuk.php?no_agenda_masuk=<?php echo $data['no_agenda_masuk'];?>">
        <span class="btn btn-sm btn-warning glyphicon glyphicon-edit" aria-hidden="true" title="Ubah"><label>edit</label></span>
        </a>
        <a href="hapus-data-surat-masuk.php?no_agenda_masuk=<?php echo $data['no_agenda_masuk'];?>">
