<html>
    ...
    <body class="body">
        ...
        ?>
        <form action="cari_surat_keluar.php" method="post" name="postform">
	<div class="container well">
	<div class="blog-header" align="center">
        <h1 class="jumbotron">CARI AGENDA SURAT KELUAR</h1>
    </div>  
    <div class="input" align="center">
        ...
        <?php
            ...
            <script language="JavaScript">
                ...
                document.location='cari_surat_keluar.php';
            </script>
            <?php
            }else{
            ...
            <?php
            $query=mysql_query("select * from tbl_surat_keluar where tgl_kirim between '$tanggal_awal' and '$tanggal_akhir'");
            }
        ?>
        </p>
        <table class="table table-bordered">
            ...
            ?>
            <tr>
                <td align="center" height="30"><?php echo $row['no_agenda_keluar']; ?></td>
                <td align="center"><?php echo $row['jenis_surat'];?></td>
                <td align="center"><?php echo $row['tgl_kirim'];?></td>
