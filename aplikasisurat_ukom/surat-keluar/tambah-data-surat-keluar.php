...
<html lang="en">
  ...
  <div class="container">
    <div class="row">
      ...
      <legend>Entri Data Surat keluar</legend>
        <form method="POST" action="simpan-data-surat-keluar.php">
          <div class="form-group">
            <div class="input-group col-md-12">
            <label>No Agenda</label>
            <input type="text" name="no_agenda_keluar" class="form-control" id="no_agenda_keluar" placeholder="no agenda" required></input>
            </div>
          </div>
          <div class="form-group">
            <div class="input-group col-md-12">
